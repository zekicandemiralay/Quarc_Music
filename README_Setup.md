...
- **Server address:** `https://100.115.252.65`
...
*Browser instead of desktop app:* After step 5, go to `https://100.115.252.65` in Chrome or Edge.
...
4. In Safari, go to `https://100.115.252.65` and log in
...
4. Go to `https://100.115.252.65` in Chrome and log in
...
4. Go to `https://100.115.252.65` and log in
