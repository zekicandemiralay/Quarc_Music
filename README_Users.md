...
- The **server address** (`https://100.115.252.65:8443/`)
...
> **Using the browser instead?** After installing the certificate, go to `https://100.115.252.65:8443` in Chrome or Edge.
...
14. Open **Safari** and go to: `https://100.115.252.65:8443`
...
17. While on `https://100.115.252.65:8443` in Safari, tap the **Share** button (the square with an arrow pointing up, at the bottom of the screen)
...
12. Open **Chrome** and go to: `https://100.115.252.65:8443`
...
9. Go to: `https://100.115.252.65:8443`
...
Make sure you're using `http://` (not `https://`) and port `8888`.
