...
- The **server address:** `https://quarcnet.tail5fe1a9.ts.net:4000`
...
The easiest way on a computer is the **Quarc Music desktop app**. Download the installer for your platform:
...
2. Open **Safari** and go to: `https://quarcnet.tail5fe1a9.ts.net:4000`
...
1. Make sure Tailscale is connected on your phone
2. Open **Chrome** and go to: `https://quarcnet.tail5fe1a9.ts.net:4000`
3. Log in with your username and password
...
2. Go to `https://quarcnet.tail5fe1a9.ts.net:4000` in any browser
3. Log in with your username and password
...
1. Make sure Tailscale is connected
2. Go to `https://quarcnet.tail5fe1a9.ts.net:4000` in Chrome or Edge
3. Log in with your username and password
