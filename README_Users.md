...
- The **server address:** `https://quarc.tail5fe1a9.ts.net:4000`
...
2. Open **Safari** and go to: `https://quarc.tail5fe1a9.ts.net:4000`
...
1. Make sure Tailscale is connected on your phone
2. Open **Chrome** and go to: `https://quarc.tail5fe1a9.ts.net:4000`
3. Log in with your username and password
...
2. Go to `https://quarc.tail5fe1a9.ts.net:4000` in any browser
3. Log in with your username and password
...
1. Make sure Tailscale is connected
2. Go to `https://quarc.tail5fe1a9.ts.net:4000` in Chrome or Edge
3. Log in with your username and password
